function Clasifica_ST_escalamiento_geometrico(total_bd_ts,porcentaje_train,k)
...
%Cross fold validation con porcentaje en TRAIN y TEST
   ...
   for i=1:10
     ...
     [classified_rate,matriz_confusion]=ST_KNN_classification_esc_geometrico(TRAIN,TEST,k);
