function [accuracy,matriz_confusion]=ST_KNN_classification_esc_geometrico(TRAIN,TEST,k)
%Clasificación de series de tiempo utilizando KNN y Series de tiempo estandarizadas con es
...
for i = 1 : length(TEST_class_labels) % Loop over every instance in the test set
    ...
    predicted_class = KNN_ST_esc_geometrico(TRAIN,TRAIN_class_labels, classify_this_object,k);
