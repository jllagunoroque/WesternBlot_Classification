function Clasifica_ST_WB_raw_DTW_Sin_restriccion_2_clases(total_bd_ts,porcentaje_train,k)
...
%Cross fold validation con porcentaje en TRAIN y TEST
   ...
   for i=1:10
     ...
     [classified_rate,matriz_confusion]=DTW_KNN_classification_raw_2clases_Sin_restriccion(TRAIN,TEST,1,3,k);
