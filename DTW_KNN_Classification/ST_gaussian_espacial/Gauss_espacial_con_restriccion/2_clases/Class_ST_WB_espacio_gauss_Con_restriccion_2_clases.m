function Class_ST_WB_espacio_gauss_Con_restriccion_2_clases(total_bd_ts,porcentaje_train,k,sigma,window)
...
%Cross fold validation con porcentaje en TRAIN y TEST
  ...
  [new_filtered_db]=gaussian_filter_all_TS_db(series_tiempo,sigma);
   ...
   for i=1:10
     ...
     [classified_rate,matriz_confusion]=DTW_KNN_class_espacio_gauss_raw_2clases_Con_restriccion(TRAIN,TEST,1,3,k,window);
