function [accuracy,matriz_confusion]=DTW_KNN_class_espacio_gauss_raw_2clases_Con_restriccion(TRAIN,TEST,clase1,clase2,k,window)
%Clasificación de series de tiempo Raw utilizando KNN y DTW Con restricciones.
