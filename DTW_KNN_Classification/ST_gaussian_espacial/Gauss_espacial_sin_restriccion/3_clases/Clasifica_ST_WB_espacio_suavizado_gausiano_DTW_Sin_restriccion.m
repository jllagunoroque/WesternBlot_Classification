function Clasifica_ST_WB_espacio_suavizado_gausiano_DTW_Sin_restriccion(total_bd_ts,porcentaje_train,k,sigma)
...
%de la matriz de confusión se debe calcular sólo con 2 clases
   ...
   for i=1:10
     ...
     [classified_rate,matriz_confusion]=DTW_KNN_classification_spatial_gaussian_sin_restriccion(TRAIN,TEST,k);
