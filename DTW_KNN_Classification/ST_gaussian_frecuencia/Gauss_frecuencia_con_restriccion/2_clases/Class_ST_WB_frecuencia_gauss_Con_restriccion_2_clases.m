function Class_ST_WB_frecuencia_gauss_Con_restriccion_2_clases(total_bd_ts,porcentaje_train,k,sigma,window)
...
%Cross fold validation con porcentaje en TRAIN y TEST
   ...
   for i=1:10
     ...
     [classified_rate,matriz_confusion]=DTW_KNN_class_frec_gauss_2clases_Con_restriccion(TRAIN,TEST,1,3,k,window);
