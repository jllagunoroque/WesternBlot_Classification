function Clasif_ST_WB_frecuency_suavizado_gauss_DTW_Con_restriccion(total_bd_ts,porcentaje_train,k,sigma,window)
...
%Cross fold validation con porcentaje en TRAIN y TEST
   ...
   for i=1:10
     ...
     [classified_rate,matriz_confusion]=DTW_KNN_classification_Frecuency_gaussian_restricciones(TRAIN,TEST,k,window);
