function [accuracy,matriz_confusion]=DTW_KNN_classification_frec_gauss_2clases_Sin_restriccion(TRAIN,TEST,clase1,clase2,k)
%Clasificación de series de tiempo suavizado gaussiano en el dominio de frecuencia con KNN y DTW Sin restricciones.
