function [accuracy,matriz_confusion]=DTW_KNN_classification_frecuency_gaussian_sin_restriccion(TRAIN,TEST,k)
%Clasificación de series de tiempo utilizando KNN y Series de tiempo con filtrado gaussiano en el dominio del espacio.
